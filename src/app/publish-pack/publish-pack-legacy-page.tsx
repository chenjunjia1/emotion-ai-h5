...
export function PublishPackLegacyPage() {
  ...
  return (
    <AppShell showHeader={false}>
      <div className="border-b border-amber-100 bg-amber-50 px-4 py-2 text-center text-[11px] font-bold text-amber-800">
        旧版发布包将逐步下线，推荐使用
        <Link href="/publish-pack" className="mx-1 text-pink-600 underline">
          新版快速/高级模式
        </Link>
      </div>
